INSERT INTO review (activity_id,timestamp,participant,comment)
SELECT DISTINCT j.activity_id, (a.start_date_time + '8 hours' + RANDOM() * (NOW()-a.start_date_time)) AS random_timestamp, j.participant, rc.comment
